  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={`${TOOTH_SLOT_HEIGHT} flex items-center justify-center px-2  ${developerMode ? `border-2 border-purple-500 border-dashed relative` : ''}`}>
        {developerMode && (
          <span className="absolute -top-6 left-0 text-xs text-purple-300 font-mono bg-gray-800 px-1">Grupo 2 Row</span>
        )}
        <div className="flex items-center gap-1">
          ...
          <div className="w-0.5 h-16 bg-blue-800/50 mx-2"></div>
      ...
      <div className={`${showBiteEffect || showTemporaryTeeth ? TEMPORARY_TOOTH_SLOT_HEIGHT : 'h-0 overflow-hidden'} transition-all duration-300 flex items-center justify-center px-2  ${developerMode && showTemporaryTeeth ? `border-2 border-purple-500 border-dashed relative` : ''}`}>
        {developerMode && (
          <span className="absolute -top-6 left-0 text-xs text-purple-300 font-mono bg-gray-800 px-1">Temp Upper Row (Group 2)</span>
        )}
...
isUpper={true}
          ...
          {/* Separador entre incisivos centrales */}
          <div className="w-0.5 h-12 bg-orange-500/50 mx-2"></div>
      ...
      <div className={`${showBiteEffect || showTemporaryTeeth ? TEMPORARY_TOOTH_SLOT_HEIGHT : 'h-0 overflow-hidden'} transition-all duration-300 flex items-center justify-center px-2  ${developerMode && showTemporaryTeeth ? `border-2 border-purple-500 border-dashed relative` : ''}`}>
        {developerMode && (
          <span className="absolute -top-6 left-0 text-xs text-purple-300 font-mono bg-gray-800 px-1">Temp Lower Row (Group 5)</span>
        )}
        {showTemporaryTeeth && !showBiteEffect && (
          <div className="flex items-center gap-1">
      ...
      <div className={`${TOOTH_SLOT_HEIGHT} flex items-center justify-center px-2 ${developerMode ? `border-2 border-purple-500 border-dashed relative` : ''}`}>
        {developerMode && (
          <span className="absolute -top-6 left-0 text-xs text-purple-300 font-mono bg-gray-800 px-1">Grupo 5 Row</span>
        )}
        <div className="flex items-center gap-1">
